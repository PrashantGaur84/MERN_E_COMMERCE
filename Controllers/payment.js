...
const razorpay = new Razorpay({
    ...
    key_secret: process.env.Razorpay_k_secret ,
});
...
export const verify = async (req, res) => {
    ...
    try {
        ...
        let orderConfirm = await Payment.create({ orderId, paymentId, signature, amount, orderItems, userId, userShipping, payStatus: "paid" });
